...
ENV OPENMRS_PLATFORM_VERSION="1.9.10"
ENV OPENMRS_PLATFORM_URL="http://sourceforge.net/projects/openmrs/files/releases/OpenMRS_Platform_1.9.10/openmrs.war/download"
ENV OPENMRS_REFERENCE_VERSION=""
ENV OPENMRS_REFERENCE_URL=""
ENV DATABASE_SCRIPT_FILE="openmrs-1.9.10.sql.zip"
...
ENV DEFAULT_DB_NAME="openmrs_1_9_10"
