...
ENV OPENMRS_PLATFORM_URL="http://sourceforge.net/projects/openmrs/files/releases/OpenMRS_Platform_1.11.3/openmrs.war/download"
ENV OPENMRS_REFERENCE_VERSION=""
ENV OPENMRS_REFERENCE_URL=""
ENV DATABASE_SCRIPT_FILE="openmrs-1.11.3.sql.zip"
ENV DATABASE_SCRIPT_PATH="db/${DATABASE_SCRIPT_FILE}"

ENV DEFAULT_DB_NAME="openmrs_1_11_3"
